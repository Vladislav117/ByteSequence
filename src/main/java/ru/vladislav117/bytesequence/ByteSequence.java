package ru.vladislav117.bytesequence;
...
public class ByteSequence {
    ...
    public ByteSequence setIndex(int index) {
    ...
    /**
     * Чтение длины массива байтов и самого массива байтов. Индекс будет смещён на 4 байта + длина массива.
     *
     * @return Прочитанный массив.
     */
    public byte[] readBytesWithLength() {
        return readBytes(readInteger());
    }

    /**
     * Чтение массива байтов и смещение индекса на длину этого массива.
     * После прочтения массив байтов будет упакован в ByteSequence.
     *
     * @param size Размер массива
     * @return Прочитанный массив.
     */
    public ByteSequence readByteSequence(int size) {
        return new ByteSequence(readBytes(size));
    }
     ...
     * @return Прочитанный массив.
     */
    public ByteSequence readByteSequenceWithLength() {
        return new ByteSequence(readBytesWithLength());
    }
     ...
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeBoolean(boolean value) {
     ...
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeByte(byte value) {
        bytes[index++] = value;
        return this;
    }
     ...
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeShort(short value) {
     ...
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeCharacter(char value) {
     ...
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeInteger(int value) {
     ...
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeLong(long value) {
     ...
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeFloat(float value) {
     ...
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeDouble(double value) {
     ...
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeBytes(byte[] bytes) {
    ...
    /**
     * Запись массива байтов и смещение индекса на длину этого массива.
     * Перед массивом будет записана его длина.
     *
     * @param bytes Массив байтов
     * @return Этот же объект.
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeBytesWithLength(byte[] bytes) {
        if (index + Integer.BYTES + bytes.length > this.bytes.length)
     ...
     * Запись массива байтов и смещение индекса на длину этого массива.
     *
     * @param byteSequence Массив байтов в виде ByteSequence
     * @return Этот же объект.
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeByteSequence(ByteSequence byteSequence) {
        writeBytes(byteSequence.bytes);
        return this;
    }
     ...
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeByteSequenceWithLength(ByteSequence byteSequence) {
        writeBytesWithLength(byteSequence.bytes);
        return this;
    }
     ...
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeString(String string, Charset charset) {
     ...
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeString(String string) {
     ...
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeStringWithLength(String string, Charset charset) {
     ...
     */
    @SuppressWarnings("UnusedReturnValue")
    public ByteSequence writeStringWithLength(String string) {
